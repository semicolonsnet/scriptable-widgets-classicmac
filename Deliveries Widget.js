...
// icon-color: red; icon-glyph: archive;
// src/settings.ts
var params = JSON.parse(args.widgetParameter) || {};
var settings = {
  debug: true,
  calendarApp: "calshow",
  backgroundImage: params.bg ? params.bg : "widgettop.PNG",
  widgetBackgroundColor: "#000000",
  todayTextColor: "#000000",
  markToday: true,
  todayCircleColor: "#ffffff",
...
function addWidgetTextLine(
  ...
  if (typeof fontName === "string") {
    textLine.font = new Font(fontName, textSize);
  } else {
    textLine.font = font;
  }
